...
void sensor_msg_init(sensor_msgs::Range &range_name, char *frame_id_name)
{
  ...
  range_name.field_of_view = FIELD_OF_VIEW; // ~ 14.89 degree
  range_name.min_range = MIN_DISTANCE/100; // cm to meters;
  range_name.max_range = MAX_DISTANCE/100; // cm to meters;
}
...
void publishInRosTopics(){
  ...
  // pub_range_sensor_1.publish(&range_sensor_4);
  // pub_range_sensor_2.publish(&range_sensor_5);
  // pub_range_sensor_3.publish(&range_sensor_6);
}
...
void setup() {
  ...
  // sensor_msg_init(range_sensor_1, "/ultrasound_4");
  // sensor_msg_init(range_sensor_2, "/ultrasound_5");
  // sensor_msg_init(range_sensor_3, "/ultrasound_6");
}
